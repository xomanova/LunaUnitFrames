...
function LUF:CreateConfig()
	...
	local moduleOptions = {
		...
		["aoeAssist"] = {
			...
			args = {
				description = {
					name = L["Shows an icon on the best Chain Heal target. Only available for Shamans."],
					type = "description",
					order = 0,
				},
				enabled = {
					name = ENABLE,
					desc = string.format(L["Enable or disable the %s."],L["AOE Assist"]),
					type = "toggle",
					order = 1,
				},
				anchorPoint = {
					name = L["Anchor point"],
					desc = L["Where the indicator should be anchored."],
					type = "select",
					order = 2,
					values = { ["TOPLEFT"] = L["Top left"], ["TOP"] = L["Top"], ["TOPRIGHT"] = L["Top right"], ["LEFT"] = L["Left"], ["CENTER"] = L["Center"], ["RIGHT"] = L["Right"], ["BOTTOMLEFT"] = L["Bottom left"], ["BOTTOM"] = L["Bottom"], ["BOTTOMRIGHT"] = L["Bottom right"] },
				},
				size = {
					name = L["Size"],
					desc = L["Set the size."],
				...
				x = {
					name = L["X offset"],
					desc = L["X offset from anchor point."],
					type = "range",
					order = 4,
					min = -50,
					max = 50,
				...
				y = {
					name = L["Y offset"],
					desc = L["Y offset from anchor point."],
					type = "range",
					order = 5,
					min = -50,
					max = 50,
				...
				minHealAmount = {
					name = L["Min Heal Threshold"],
					desc = L["Minimum total healing required before showing the indicator."],
					type = "range",
					order = 6,
					min = 500,
					max = 20000,
				...
				showOnlyBest = {
					name = L["Show only best"],
					desc = L["Only show the indicator on the single best target instead of all valid targets."],
					type = "toggle",
					order = 7,
				},
				showHealAmount = {
					name = L["Show heal amount"],
					desc = L["Display the estimated total healing on the indicator."],
					type = "toggle",
					order = 8,
				},
				showTargetCount = {
					name = L["Show target count"],
					desc = L["Display the number of targets that would be healed."],
					type = "toggle",
					order = 9,
				},
			},
