...
local spellRankTableData = {
	[1] = { 774, 8936, 5185, 740, 635, 19750, 139, 2060, 596, 2061, 2054, 2050, 1064, 331, 8004, 136, 755, 689, 746, 33763, 32546, 37563, 48438, 61295, 51945, 50464, 47757, 408120, 408124, 402277, 415236, 415240, 412510, 401417, 417057, 425268, 436937, 408247, 458856, 408521 },
		...
		GetHealTargets = function(bitType, guid, spellID)
			...
			elseif( spellName == PrayerofHealing ) then
				...
				for groupGUID, id in pairs(guidToGroup) do
					...
					-- Also applies to TBC Classic Anniversary (2.5.x)
