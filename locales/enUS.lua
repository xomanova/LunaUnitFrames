...
["Percentage to increase indicator size for each additional target hit. Set to 0 for same size regardless of targets."] = "Percentage to increase indicator size for each additional target hit. Set to 0 for same size regardless of targets.",
["Persistence Settings"] = "Persistence Settings",
["Default Duration"] = "Default Duration",
["How long the indicator shows for normal effectiveness heals (seconds)."] = "How long the indicator shows for normal effectiveness heals (seconds).",
["High Effectiveness Duration"] = "High Effectiveness Duration",
["How long the indicator shows when total healing exceeds the high threshold (seconds)."] = "How long the indicator shows when total healing exceeds the high threshold (seconds).",
["Low Effectiveness Duration"] = "Low Effectiveness Duration",
["How long the indicator shows for low effectiveness heals (seconds)."] = "How long the indicator shows for low effectiveness heals (seconds).",
["High Threshold"] = "High Threshold",
["Total healing amount that triggers high effectiveness duration."] = "Total healing amount that triggers high effectiveness duration.",
["Low Threshold"] = "Low Threshold",
["Per-target healing below this with only 1 target triggers low effectiveness duration."] = "Per-target healing below this with only 1 target triggers low effectiveness duration.",
["Colors"] = "Colors",
["1 Target Color"] = "1 Target Color",
["Color when heal hit only 1 target."] = "Color when heal hit only 1 target.",
["2 Target Color"] = "2 Target Color",
["Color when heal hit 2 targets."] = "Color when heal hit 2 targets.",
["3+ Target Color"] = "3+ Target Color",
["Color when heal hit 3 or more targets."] = "Color when heal hit 3 or more targets.",
}
